...
namespace Stack.DAL.Migrations
{
    ...
    [Migration("20201213111754_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Stack.Entities.Models.Administrator", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Stack.Entities.Models.Barber", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Stack.Entities.Models.BarberLogin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Stack.Entities.Models.BarberProfilePhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Stack.Entities.Models.BarberQueue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Stack.Entities.Models.CompleteOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Stack.Entities.Models.DailyReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Stack.Entities.Models.GuestNumber", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Stack.Entities.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Stack.Entities.Models.OrderFeedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Stack.Entities.Models.OrderFeedbackQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Stack.Entities.Models.OrderService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Stack.Entities.Models.PromoCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Stack.Entities.Models.SMS", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Stack.Entities.Models.Service", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Stack.Entities.Models.ServiceFeedBackQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Stack.Entities.Models.Shop", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Stack.Entities.Models.Administrator", b =>
                {
                    b.HasOne("Stack.Entities.Models.Shop", "Shop")
            ...
            modelBuilder.Entity("Stack.Entities.Models.BarberProfilePhoto", b =>
                {
                    b.HasOne("Stack.Entities.Models.Barber", "Barber")
                        .WithOne("BarberProfilePhoto")
                        .HasForeignKey("Stack.Entities.Models.BarberProfilePhoto", "BarberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Stack.Entities.Models.BarberQueue", b =>
                {
                    b.HasOne("Stack.Entities.Models.Barber", "Barber")
                        .WithOne("BarberQueue")
                        .HasForeignKey("Stack.Entities.Models.BarberQueue", "BarberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Stack.Entities.Models.Order", b =>
                {
                    b.HasOne("Stack.Entities.Models.BarberQueue", "BarberQueue")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Stack.Entities.Models.OrderFeedback", b =>
                {
                    b.HasOne("Stack.Entities.Models.CompleteOrder", "CompleteOrder")
                        .WithOne("OrderFeedback")
                        .HasForeignKey("Stack.Entities.Models.OrderFeedback", "CompleteOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Stack.Entities.Models.OrderFeedbackQuestion", b =>
                {
                    b.HasOne("Stack.Entities.Models.OrderFeedback", "OrderFeedback")
            ...
            modelBuilder.Entity("Stack.Entities.Models.OrderService", b =>
                {
                    b.HasOne("Stack.Entities.Models.Order", "Order")
            ...
            modelBuilder.Entity("Stack.Entities.Models.ServiceFeedBackQuestion", b =>
                {
                    b.HasOne("Stack.Entities.Models.Service", "Service")
